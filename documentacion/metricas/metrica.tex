...
\begin{document}
    ...
    \begin{titlepage}
        ...
        \vspace{0.2cm}  % Espacio entre el bloque anterior y el siguiente texto
    ...
    \begin{center}
        \Huge \textbf{METRICAS}\par\vspace{1cm}
        %\huge \textbf{preparar el entorno y sentar las bases para el desarrollo del proyecto}
    \end{center}
    \vfill
    \hfill
